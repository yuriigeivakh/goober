...
const Toast: React.FC<ToastProps> = ({ type, message, onClose }) => {
  ...
  return (
    <div className={`flex mt-2 mb-2 items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 ${bgColor[type]}`} role="alert">
